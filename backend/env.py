...
import handlers
from mailchimp.mailchimp import (ListAlreadySubscribedError, ListDoesNotExistError, ListInvalidImportError,
                                 ValidationError)
import model
...
def _subscribe_to_mailchimp(email_to_subscribe, first_name, last_name,
  ...
  try:
    mc.lists.subscribe(id=mailchimp_list_id,
                       ...
                       send_welcome=False)
  except (ValidationError, ListDoesNotExistError, ListAlreadySubscribedError, ListInvalidImportError) as e:
    logging.error(e)
